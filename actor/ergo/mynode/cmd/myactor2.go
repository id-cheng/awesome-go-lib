...
func factory_MyActor2() gen.ProcessBehavior {
	return &MyActor2{}
}
...
func (a *MyActor2) Init(args ...any) error {
...
func (a *MyActor2) HandleMessage(from gen.PID, message any) error {
...
func (a *MyActor2) HandleCall(from gen.PID, ref gen.Ref, request any) (any, error) {
	a.Log().Info("got request from %s with reference %s", from, ref)
	return gen.Atom("pong"), nil
}

// Terminate invoked on a termination process
func (a *MyActor2) Terminate(reason error) {
...
func (a *MyActor2) HandleMessageName(name gen.Atom, from gen.PID, message any) error {
	return nil
}

// HandleMessageAlias invoked if split handling was enabled using SetSplitHandle(true)
// and message has been sent by alias
func (a *MyActor2) HandleMessageAlias(alias gen.Alias, from gen.PID, message any) error {
	return nil
}

// HandleCallName invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by name
func (a *MyActor2) HandleCallName(name gen.Atom, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}

// HandleCallAlias invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by alias
func (a *MyActor2) HandleCallAlias(alias gen.Alias, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}
...
func (a *MyActor2) HandleLog(message gen.MessageLog) error {
	return nil
}
...
func (a *MyActor2) HandleEvent(message gen.MessageEvent) error {
	return nil
}

// HandleInspect invoked on the request made with gen.Process.Inspect(...)
func (a *MyActor2) HandleInspect(from gen.PID, item ...string) map[string]string {
