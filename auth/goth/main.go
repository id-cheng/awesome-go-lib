...
func main() {
	goth.UseProviders(
		// Use twitter2 instead of twitter if you only have access to the Essential API Level
		...
		// twitter2.NewAuthenticate(os.Getenv("TWITTER_KEY"), os.Getenv("TWITTER_SECRET"), "http://localhost:3000/auth/twitterv2/callback"),
		...
		microsoftonline.New(os.Getenv("MICROSOFT_ONLINE_KEY"), os.Getenv("MICROSOFT_ONLINE_SECRET"), "http://localhost:3000/auth/microsoftonline/callback"),
